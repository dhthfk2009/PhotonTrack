...
#include "B1HodoscopeHit.hh"
#include "B1DriftChamberHit.hh"
#include "B1EmCalorimeterHit.hh"
#include "B1HadCalorimeterHit.hh"
#include "B1Constants.hh"
...
void B1EventAction::EndOfEventAction(const G4Event* event)
{
  ...
  auto hHC1 
    = static_cast<B1HodoscopeHitsCollection*>(hce->GetHC(fHodHC1ID));
    
  auto hHC2 
    = static_cast<B1HodoscopeHitsCollection*>(hce->GetHC(fHodHC2ID));
    
  auto dHC1 
    = static_cast<B1DriftChamberHitsCollection*>(hce->GetHC(fDriftHC1ID));
    
  auto dHC2 
    = static_cast<B1DriftChamberHitsCollection*>(hce->GetHC(fDriftHC2ID));
    
  auto ecHC 
    = static_cast<B1EmCalorimeterHitsCollection*>(hce->GetHC(fEmCalHCID));
    
  auto hcHC 
    = static_cast<B1HadCalorimeterHitsCollection*>(hce->GetHC(fHadCalHCID));
